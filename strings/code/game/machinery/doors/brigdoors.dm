...
/obj/machinery/door_timer/proc/timer_start()
	...
	for(var/obj/machinery/door/window/brigdoor/door in targets)
		if(door.density)
			continue
		addtimer(CALLBACK(door, TYPE_PROC_REF(/obj/machinery/door/window/brigdoor, close)), 0)
...
/obj/machinery/door_timer/proc/timer_end(forced = FALSE)
	...
	for(var/obj/machinery/door/window/brigdoor/door in targets)
		if(!door.density)
			continue
		addtimer(CALLBACK(door, TYPE_PROC_REF(/obj/machinery/door/window/brigdoor, open)), 0)
